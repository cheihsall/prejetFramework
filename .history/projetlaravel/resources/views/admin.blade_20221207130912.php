    ...
    <header>
        <nav class="navbar navbar-expand-lg bg-success p-4">
            ...
            <form class="d-flex" role="search" action="recherche" method="post">
                <input class="form-control me-2" name="prenom" id="recherche" onclick="search()" value="{{ request()->prenom ?? ''}}" type="search" placeholder="rechercher par prenom" aria-label="Search">
