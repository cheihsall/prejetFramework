...
<nav aria-label="...">
    <ul class="pagination fixed-bottom justify-content-center">
      <li class="page-item disabled">
        <a class="page-link link-success"><img src="/image/precedent.png" alt="" width="30" height="20"></a>
      </li>
      ...
      <li class="page-item">
        <a class="page-link link-success" href="#"><img src="/image/suivant.png" alt="" width="30" height="20"></a>
      </li>
    </ul>
  </nav>
</div>
