...
<body>
 ...
 -->
        <div class="col-md-8 ">
            ...
            <div class="row d-flex justify-content-center bg-white-50 t-5 border border-danger">
              


                <form action="{{route('login.store') }}" method="post" class="row g-2  d-block  col-md-8  bg-light needs-validation border border-danger " novalidate>
                    @csrf
