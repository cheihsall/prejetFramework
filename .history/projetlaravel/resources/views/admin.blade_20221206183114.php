...
<body>
  ...
  @foreach ($users as $user)
    <tr>
     ...
     {{--  <td>{{{ $u->etat }}}</td> --}}
     {{--  <td>{{{ $u->motdepasse }}}</td> --}}
      <td><a href="/api/posts/switchRole/{{$u->id}}?post"><img src="/image/change.png" alt="changer"></a>
        {{-- <form action="/api/posts/switchRole/{{$u->id}}" method="post">
        <button type="submit"><img src="/image/change.png" alt=""></button>
    </form> --}}
        <a href="/api/posts/archiv/{{$u->id}}"><img src="/image/archiv.png" alt="archiver"></a>
        <a href="posts/editForm/{{$u->id}}"><img src="/image/edit.png" alt="modifier"></a>
       {{--  <a href="/api/posts/switchRole/{{$u->id}}?post"><img src="/image/edit.png" alt=""></a> --}}
  </td>
    </tr>
    @endforeach
  </tbody>
