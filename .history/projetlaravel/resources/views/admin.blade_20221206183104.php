  ...
  @foreach ($users as $user)
    <tr>
     ...
     {{--  <td>{{{ $users->motdepasse }}}</td> --}}
      <td><a href="/api/posts/switchRole/{{$users->id}}?post"><img src="/image/change.png" alt="changer"></a>
        {{-- <form action="/api/posts/switchRole/{{$users->id}}" method="post">
        <button type="submit"><img src="/image/change.png" alt=""></button>
    </form> --}}
        <a href="/api/posts/archiv/{{$users->id}}"><img src="/image/archiv.png" alt="archiver"></a>
        <a href="posts/editForm/{{$users->id}}"><img src="/image/edit.png" alt="modifier"></a>
       {{--  <a href="/api/posts/switchRole/{{$users->id}}?post"><img src="/image/edit.png" alt=""></a> --}}
  </td>
    </tr>
    @endforeach
  </tbody>
