            ...
            <div class="d-flex justify-content-center mt-5 ">
                ...
                <form action="{{route('login.store')}}" method="post" class="row g-2 d-block bg-transparent col-md-8">
                    ...
                    <div class="col-md-12 p-3">
                        ...
                        <input id="email" class="form-control border-dark p-3 " type='text' id="email" name='email' required placeholder=" Email ">
                    ...
                    <div class="col-md-12 p-3 ">
                        ...
                        <input id="passwords" class="form-control border-dark p-3" type="password" name="mdp" id="mdp"required placeholder="mot de passe">
