 ...
 -->
        <div class="col-md-8 ">
            ...
            <div class="row d-flex justify-content-center  bg-white-50 t-5 ">
                ...
                <form action="{{route('login.store') }}" method="post" class="row g-2 d-block bg-red col-md-8 needs-validation" novalidate>
                    @csrf
                    ...
                    <div class="col-md-12 p-2 input-control">
                        ...
                        <input id="email" class="form-control border-dark p-" type='text' id="email" name='email' placeholder=" Email ">
