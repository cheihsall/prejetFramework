    ...
    <header>
        <nav class="navbar navbar-expand-lg bg-success p-4">
            ...
            <form class="d-flex" role="search" action="recherche" method="post">
                ...
                <button class="btn btn-outline-light p-1" id="recherche" onchange="" type="submit">rechercher</button>
            </form>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <ul class="nav-item ">
                <a href="">
                <button type="button" id="quit" class="btn btn-outline-danger mt-3 p-1 "><img src="/image/quit.png" alt="quitter" width="30"></button>
            </a>
     </ul>
            <a href="/login">
