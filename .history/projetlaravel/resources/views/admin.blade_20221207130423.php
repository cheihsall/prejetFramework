    ...
    <header>
        <nav class="navbar navbar-expand-lg bg-success p-4">
            ...
            <form class="d-flex" role="search" action="recherche" method="post">
                ...
                <button class="btn btn-outline-light p-1" id="recherche" onclick="search()" type="submit">rechercher</button>
            </form>&nbsp;
            <div class="nav-item mb-3 p-2" >
                <a href="/api/posts">
                <button type="button" id="quit" onchange="search()" class="btn btn-outline-danger mt-3 p-1 "   style="display:none">
