    ...
    <header>
        <nav class="navbar navbar-expand-lg bg-success p-4">
            ...
            <form class="d-flex" role="search" action="recherche" method="post">
                <input class="form-control me-2" name="prenom" type="search" onchange="search('zzz')" placeholder="rechercher par prenom" aria-label="Search">
                <button class="btn btn-outline-light p-1" id="recherche"  type="submit">rechercher</button>
            </form>&nbsp;
            <div class="nav-item mb-3 p-2" id="quit">
                <a href="/api/posts">
                <button type="button" class="btn btn-outline-danger mt-3 p-1 " style="display: none">
