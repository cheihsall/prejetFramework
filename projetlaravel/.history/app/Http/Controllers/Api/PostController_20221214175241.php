...
//Debut créationn de la page de connexion
    ...
    {
        $request->validate([ // creation d'une variable reponse puis intégration de la méthode validate pour accepter si les règles de validation sont accepté oui ou  non
            ////////////
