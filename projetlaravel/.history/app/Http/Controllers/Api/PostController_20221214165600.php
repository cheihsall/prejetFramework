...
//Debut créationn de la page de connexion
    ...
    {
        $request->validate([ // creation d'une variable reponse4 puis intégration de la méthode validate pour acepter si les règle de validation sont accepté oui oou  non
            ////////////
