...
//Debut créationn de la page de connexion
    ...
    {
        $request->validate([ // creation d'une variable reponse puis intégration de la méthode validate pour accepter si les règles de validation sont acceptées oui ou  non
            ////////////
            'email' => ['required', 'email', 'regex: /^([a-z0-9\+_\-]+)(\.[a-z0-9\+_\-]+)*@([a-z0-9\-]+\.)+[a-z]{2,6}$/'],//email pour controler que le champ est obigatoire ,que l'email valid,écrit correctement
