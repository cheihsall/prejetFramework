...
<body>
    ...
    <header>
        ...
        <div class="d-flex justify-content-center m-3 navbar-nav me-auto mb-lg-0">
          <a class="nav-link active text-light m-2" aria-current="page" href="/api/admin"><button type="button" class="btn btn-outline-success "style="padding-left:345px; padding-top:4px;">


            <i class="fa-solid fa-user-check" style="color:white; font-size:35px;padding-left:345px; padding-top:4px;">></i> User actifs
  ...
  @foreach ($users as $user)
    <tr>
     ...
     <td> {{-- <a href="/api/posts/switchRole/{{$user->id}}?post"><img src="/image/change.png" alt=""></a> --}}
        ...
        <a href="/api/posts/desarchiv/{{$user->id}}"><i class="fa-sharp fa-solid fa-box-archive"style="color:black; padding-left:25px"></i></a>
