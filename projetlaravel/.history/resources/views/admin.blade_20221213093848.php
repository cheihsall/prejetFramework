        ...
        <nav class="navbar navbar-expand-lg bg-success p-4">
            ...
            <div class="d-flex justify-content-center m-3 navbar-nav me-auto mb-lg-0">
                <a class="nav-link active text-light m-2" aria-current="page" href="/api/listearchive"><button type="button" class="btn btn-outline-success ">
                    ...
                    <i class="fa-solid fa-list" style="color:white; font-size:35px; padding-top:12px;"></i> <br>  <span>liste des archives</span>
  ...
  @foreach ($users as $user)
    <tr>
     ...
     {{--  <td>{{{ $user->motdepasse }}}</td> --}}
      ...
      <td>
        <a href="/api/posts/switchRole/{{$user->id}}?post"><button class="btn btn-outline-white "><i class="fa-solid fa-rotate-right" style="color:red"></i>Changer de statut</button></a>
