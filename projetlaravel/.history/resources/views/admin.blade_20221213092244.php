        ...
        <nav class="navbar navbar-expand-lg bg-success p-4">
            ...
            <a href="/api/logout">
                <button type="button" class="btn btn-outline-success "><i
                    class="fa-solid fa-arrow-right-from-bracket" style="color: red"></i>Deconnecter</button>
            </a>
        </nav>
  ...
  @foreach ($users as $user)
    <tr>
     ...
     {{--  <td>{{{ $user->motdepasse }}}</td> --}}
      ...
      <td>
        <a href="/api/posts/switchRole/{{$user->id}}?post"><i class="fa-solid fa-rotate-right" style="color:green"></i></a>
        <a href="/api/posts/archiv/{{$user->id}}"><i class="fa-solid fa-box-archive "style="color: green"></i></a>
        <a href="posts/editForm/{{$user->id}}"><i class="fa-solid fa-pen-to-square "style="color: green"></i></a>
     </td>
    </tr>
    @endforeach
  </tbody>
