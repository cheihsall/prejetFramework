  ...
  @foreach ($users as $user)
    <tr>
     ...
     <td> {{-- <a href="/api/posts/switchRole/{{$user->id}}?post"><img src="/image/change.png" alt=""></a> --}}
        ...
        <a href="/api/posts/desarchiv/{{$user->id}}"><i class="fa-solid fa-inbox-out"></i><i class=" fa-solid inbox-open"style="color:red; padding-left:25px"title="Désarchiver"></i></a>
