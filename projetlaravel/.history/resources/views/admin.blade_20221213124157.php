...
{{--       <th scope="col">Role</th> --}}
  ...
  @foreach ($users as $user)
    <tr>
      ...
      <td>{{{ $user->role }}}</td>
      <td>
        <a href="/api/posts/switchRole/{{$user->id}}?post"><i class="fa-solid fa-rotate-right" style="color: black"title="archiver"></i></a>
        <a href="posts/editForm/{{$user->id}}"><i class="fa-solid fa-pen-to-square"style="color:blue"title="archiver"></i></a>
