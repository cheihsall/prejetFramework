    ...
    <tr>
     ...
     {{--  <td>{{{ $user->motdepasse }}}</td> --}}
      ...
      <td><a href="/api/posts/switchRole/{{$user->id}}?post"><i class="fa-solid fa-rotate-right " style="color: green"></i></a>
        ...
        <a href="/api/posts/archiv/{{$user->id}}"><i class="fa-solid fa-box-archive bg-success"></i></a>
        <a href="posts/editForm/{{$user->id}}"><i class="fa-solid fa-pen-to-square bg-success"></i></a>
