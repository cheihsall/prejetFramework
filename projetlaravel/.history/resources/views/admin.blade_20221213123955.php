...
{{--       <th scope="col">Role</th> --}}
  ...
  @foreach ($users as $user)
    <tr>
      ...
      <td>{{{ $user->role }}}</td>
      <td>
        <a href="/api/posts/switchRole/{{$user->id}}?post"><i class="fa-solid fa-rotate-right" style="color:red""color: black"></i></a>
        <a href="/api/posts/archiv/{{$user->id}}"><i class="fa-solid fa-box-archive "style=></i></a>
