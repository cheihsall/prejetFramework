  ...
  @foreach ($users as $user)
    <tr>
      ...
      <td>
        ...
        <a href="posts/editForm/{{$user->id}}"><i class="fa-solid fa-pen-to-square"style="color:blue"title></i></a>
        <a href="/api/posts/archiv/{{$user->id}}"><i class="fa-solid fa-box-archive"style="color:red"title></i></a>
     </td>
    </tr>
    @endforeach
  </tbody>
