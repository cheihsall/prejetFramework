      ...
      <ul class="nav-item m-2">
        <a href="/login">
            <button type="button" class="btn btn-outline-success "><i
              class="fa-solid fa-arrow-right-from-bracket" style="color:white; font-size:35px; padding-top:12px;"></iDeconnecter</button>
        </a>
    </ul>
</nav>
    </header>
  ...
  @foreach ($users as $user)
    <tr>
     ...
     <td> {{-- <a href="/api/posts/switchRole/{{$user->id}}?post"><img src="/image/change.png" alt=""></a> --}}
        ...
        <a href="/api/posts/desarchiv/{{$user->id}}"><i class="fa-sharp fa-solid fa-box-archive"style="color:black; padding-left:45px"></i></a>
